...
/**
 * Decorator to add a Garlic Dressing to a Salad order.
 * @author Thorsten 'stepo' Hallwas
 */
class GarlicDressingDecorator extends AbstractOrderDecorator
{
    ...
    {
        return $this->order->getName().' with garlic dressing';
    }
    ...
    {
        return $this->order->getKiloCalories() + 77;
    }
