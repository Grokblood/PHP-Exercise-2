...
/**
 * Decorator to add mayonnaise to to a fries order.
 * @author Thorsten 'stepo' Hallwas
 */
class MayonnaiseDecorator extends AbstractOrderDecorator
{
    ...
    {
        return $this->order->getName().' with mayonnaise';
    }
    ...
    {
        return $this->order->getKiloCalories() + 149;
    }
